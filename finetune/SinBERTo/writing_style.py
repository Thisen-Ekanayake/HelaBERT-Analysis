"""
Fine-tuning SinBERTo for Writing Style Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SinBERTo FINE-TUNING — 5-FOLD CV  [WRITING STYLE CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERTo_finetuned_writing_style_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERTo-writing-style-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — SinBERTo / Writing Style Classification")
final_summary_lines.append("=" * 80)
