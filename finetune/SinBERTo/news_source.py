"""
Fine-tuning SinBERTo for News Source Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SinBERTo FINE-TUNING — 5-FOLD CV  [NEWS SOURCE CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERTo_finetuned_news_source_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERTo-news-source-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — SinBERTo / News Source Classification")
final_summary_lines.append("=" * 80)
