"""
Fine-tuning SinBERTo for Sentiment Analysis — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SinBERTo FINE-TUNING — 5-FOLD CV  [SENTIMENT ANALYSIS]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERTo_finetuned_sentiment_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERTo-sentiment-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — SinBERTo / Sentiment Analysis")
final_summary_lines.append("=" * 80)
