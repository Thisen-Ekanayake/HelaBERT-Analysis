"""
HelaBERT Fine-tuning for News Source Classification
...
Task: 9-class sentence classification (classify news headlines by source)
Sources: Sri Lanka Army, Dinamina, GossipLanka, Hiru, ITN, Lankapuwath,
         NewsLK, Newsfirst, World Socialist Web Site-Sinhala
Dataset: 24,093 samples, avg text length ~8.42 tokens (headlines)

Architecture:
  BERT encoder → [CLS] → dropout(0.1) → Linear(hidden, 9)
"""
...
print(f"Paper baseline (SinBERT-small): 60.42")
