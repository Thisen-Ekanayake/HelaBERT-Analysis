"""
Fine-tuning SinBERT_small for Sentiment Analysis — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SINBERT_SMALL FINE-TUNING — 5-FOLD CV  [SENTIMENT ANALYSIS]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERT_small_finetuned_sentiment_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERT_small-sentiment-finetuning"
...
print("\n" + "=" * 80)
print(f"5-FOLD CV COMPLETE — SinBERT_small / Sentiment Analysis")
print("=" * 80)
