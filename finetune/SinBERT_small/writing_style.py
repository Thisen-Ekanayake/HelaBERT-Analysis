"""
Fine-tuning SinBERT_small for Writing Style Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SINBERT_SMALL FINE-TUNING — 5-FOLD CV  [WRITING STYLE CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERT_small_finetuned_writing_style_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERT_small-writing-style-finetuning"
...
print("\n" + "=" * 80)
print(f"5-FOLD CV COMPLETE — SinBERT_small / Writing Style Classification")
print("=" * 80)
