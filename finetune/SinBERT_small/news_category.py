"""
Fine-tuning SinBERT_small for News Category Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SINBERT_SMALL FINE-TUNING — 5-FOLD CV  [NEWS CATEGORY CLASSIFICATION]")
print("=" * 80)

MODEL_NAME       = "SinBERT/SinBERT-small"
...
OUTPUT_DIR     = "SinBERT_small_finetuned_news_category_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERT_small-news-category-finetuning"
...
print("\n" + "=" * 80)
print(f"5-FOLD CV COMPLETE — SinBERT_small / News Category Classification")
print("=" * 80)
