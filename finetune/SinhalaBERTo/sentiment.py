"""
Fine-tuning SinhalaBERTo for Sentiment Analysis — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SinhalaBERTo FINE-TUNING — 5-FOLD CV  [SENTIMENT ANALYSIS]")
print("=" * 80)
...
OUTPUT_DIR     = "SinhalaBERTo_finetuned_sentiment_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinhalaBERTo-sentiment-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — SinhalaBERTo / Sentiment Analysis")
final_summary_lines.append("=" * 80)
