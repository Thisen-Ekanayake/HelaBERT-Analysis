"""
Fine-tuning LASER for Sentiment Analysis — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("LASER FINE-TUNING — 5-FOLD CV  [SENTIMENT ANALYSIS]")
print("=" * 80)
...
OUTPUT_DIR     = "LASER_finetuned_sentiment_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "LASER-sentiment-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — LASER / Sentiment Analysis")
final_summary_lines.append("=" * 80)
