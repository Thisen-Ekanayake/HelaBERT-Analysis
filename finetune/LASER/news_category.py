"""
Fine-tuning LASER for News Category Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("LASER FINE-TUNING — 5-FOLD CV  [NEWS CATEGORY CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "LASER_finetuned_news_category_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "LASER-news-category-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — LASER / News Category Classification")
final_summary_lines.append("=" * 80)
