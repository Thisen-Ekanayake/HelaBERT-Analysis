"""
Fine-tuning SinBERT_large for News Source Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SinBERT_large FINE-TUNING — 5-FOLD CV  [NEWS SOURCE CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERT_large_finetuned_news_source_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERT_large-news-source-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — SinBERT_large / News Source Classification")
final_summary_lines.append("=" * 80)
