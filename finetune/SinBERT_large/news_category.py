"""
Fine-tuning SinBERT_large for News Category Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SinBERT_large FINE-TUNING — 5-FOLD CV  [NEWS CATEGORY CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERT_large_finetuned_news_category_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERT_large-news-category-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — SinBERT_large / News Category Classification")
final_summary_lines.append("=" * 80)
