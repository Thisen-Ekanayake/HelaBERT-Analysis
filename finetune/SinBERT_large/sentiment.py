"""
Fine-tuning SinBERT_large for Sentiment Analysis — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("SinBERT_large FINE-TUNING — 5-FOLD CV  [SENTIMENT ANALYSIS]")
print("=" * 80)
...
OUTPUT_DIR     = "SinBERT_large_finetuned_sentiment_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "SinBERT_large-sentiment-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — SinBERT_large / Sentiment Analysis")
final_summary_lines.append("=" * 80)
