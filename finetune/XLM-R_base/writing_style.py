...
OUTPUT_DIR     = "XLM_R_base_finetuned_writing_style_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "XLM_R_base-writing-style-finetuning"
...
print("\n" + "=" * 80)
print(f"5-FOLD CV COMPLETE — XLM-R_base / Writing Style Classification")
print("=" * 80)
