"""
Fine-tuning XLM-R_BASE for News Category Classification — 5-Fold Cross Validation
...
OUTPUT_DIR     = "XLM-R_base_finetuned_news_category_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "XLM-R_base-news-category-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — XLM-R_BASE / News Category Classification")
final_summary_lines.append("=" * 80)
