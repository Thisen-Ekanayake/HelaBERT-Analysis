...
OUTPUT_DIR     = "XLM_R_base_finetuned_news_category_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "XLM_R_base-news-category-finetuning"
...
print("\n" + "=" * 80)
print(f"5-FOLD CV COMPLETE — XLM-R_base / News Category Classification")
print("=" * 80)
