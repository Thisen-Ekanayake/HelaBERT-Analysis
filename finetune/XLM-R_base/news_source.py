...
OUTPUT_DIR     = "XLM_R_base_finetuned_news_source_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "XLM_R_base-news-source-finetuning"
...
print("\n" + "=" * 80)
print(f"5-FOLD CV COMPLETE — XLM-R_base / News Source Classification")
print("=" * 80)
