"""
Fine-tuning XLM-R_BASE for News Source Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("XLM-R_BASE FINE-TUNING — 5-FOLD CV  [NEWS SOURCE CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "XLM-R_base_finetuned_news_source_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "XLM-R_base-news-source-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — XLM-R_BASE / News Source Classification")
final_summary_lines.append("=" * 80)
