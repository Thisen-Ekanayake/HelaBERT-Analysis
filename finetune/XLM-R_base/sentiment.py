"""
Fine-tuning XLM-R_BASE for Sentiment Analysis — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("XLM-R_BASE FINE-TUNING — 5-FOLD CV  [SENTIMENT ANALYSIS]")
print("=" * 80)
...
OUTPUT_DIR     = "XLM-R_base_finetuned_sentiment_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "XLM-R_base-sentiment-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — XLM-R_BASE / Sentiment Analysis")
final_summary_lines.append("=" * 80)
