"""
HelaBERT Fine-tuning for Writing Style Classification — WITH CO-ATTENTION
...
Co-Attention head (same design as sentiment_co_attn.py):
  BERT encoder
...
the paper baseline (writing_style.py). Long documents are still truncated
to MAX_SEQ_LENGTH=512 tokens (paper method).
...
OUTPUT_DIR    = "HelaBERT_large_coattention_writing_style_clsconcat"
USE_WANDB     = True
WANDB_PROJECT = "helabert_large-coattention"
WANDB_GROUP   = "writing_style_large_5runs_coattn_clsconcat"
...
for run_idx, seed in enumerate(SEEDS, start=1):
    ...
    if USE_WANDB:
        ...
        wandb.init(
            ...
            config={
                "task": "writing_style", "method": "co_attention_clsconcat",
