"""
Fine-tuning LaBSE for News Source Classification — 5-Fold Cross Validation
...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("LaBSE FINE-TUNING — 5-FOLD CV  [NEWS SOURCE CLASSIFICATION]")
print("=" * 80)
...
OUTPUT_DIR     = "LaBSE_finetuned_news_source_cv"
...
USE_WANDB      = True
WANDB_PROJECT  = "LaBSE-news-source-finetuning"
...
final_summary_lines.append("\n" + "=" * 80)
final_summary_lines.append(f"5-FOLD CV COMPLETE — LaBSE / News Source Classification")
final_summary_lines.append("=" * 80)
