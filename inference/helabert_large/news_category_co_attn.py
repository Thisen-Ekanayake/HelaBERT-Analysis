"""
HelaBERT_large Inference — News Category Classification (Co-Attention)
Loads the best-performing run from HelaBERT_large_coattention_news_category,
evaluates on the held-out test set (test/news_test.csv),
prints metrics, and saves a summary CSV.

Task:        5-class news category
Test data:   data/Sinhala-News-Category-classification/test/news_test.csv
...
Pre-processing applied (same as finetuning):
  - Remove samples with fewer than 3 whitespace-separated words
"""
...
MODEL_DIR        = "HelaBERT_large_coattention_news_category_clsconcat"
...
OUTPUT_DIR = "results_test/HelaBERT_large_coattention_news_category_clsconcat"
