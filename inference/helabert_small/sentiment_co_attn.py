"""
HelaBERT Inference — Sentiment Analysis (Co-Attention)
Loads the best-performing run from HelaBERT_coattention_sentiment,
evaluates on the held-out test set (outputs/test.csv),
prints metrics, and saves a summary CSV.

Task:        3-class sentiment (NEGATIVE, NEUTRAL, POSITIVE)
Test data:   data/sinhala-sentiment-analysis/outputs/test.csv
Text col:    comment_phrase   |  Label col: comment_sentiment
Base model:  HelaBERT_small
...
MODEL_DIR        = "HelaBERT_coattention_sentiment_clsconcat"
...
OUTPUT_DIR = "results_test/HelaBERT_small_coattention_sentiment_clsconcat"
