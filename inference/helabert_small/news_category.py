"""
HelaBERT Inference — News Category Classification
Loads the best-performing run from HelaBERT_small_paper_news_category,
evaluates on the held-out test set (test/news_test.csv),
prints metrics, and saves a summary CSV.

Task:        5-class news category (labels: 0–4)
...
MODEL_DIR        = "models/new/HelaBERT_small_paper_news_category"
