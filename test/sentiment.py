...
Two variables need to be manually configured:
  - TEST_DATA_PATH: Path to test CSV file with columns: title, body, comment_phrase, comment_sentiment
...
BEST_MODEL_PATH = "utils/finetuned_models/HelaBERT_finetuned_sentiment_baseline_cv/best_model"    # e.g., "HelaBERT_finetuned_sentiment_baseline_cv/best_model"
...
print("=" * 80)
print("SENTIMENT ANALYSIS - TEST EVALUATION")
print("=" * 80)
...
class SentimentClassifier(nn.Module):
    """BERT [CLS] classifier for sentiment"""
...
test_texts = df[comment_col].values
...
test_dataset = SentimentTestDataset(test_texts, test_labels, sp, le, COMMENT_MAX_LENGTH)
