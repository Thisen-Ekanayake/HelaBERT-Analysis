...
OPTUNA_PARAMS_FILE = "optimal_params/sentiment_comments_finetune.json"
...
LEARNING_RATE    = _optuna_params.get("learning_rate", 2.0869517190492652e-05)
WEIGHT_DECAY     = _optuna_params.get("weight_decay",  0.0725082485690241)
WARMUP_RATIO     = _optuna_params.get("warmup_ratio",  0.09752738409524904)
...
epoch_log_payload = {
    ...
    "num_train_samples": len(tr_texts),
    "num_val_samples":   len(val_texts),
    "num_test_samples":  len(test_comments),
    "label_names":       list(le.classes_),
